...
However, one should be careful when dealing with sparse matrix, especially when you need to scale the data. After you have scale the data, it could lose the sparsity and make the training process slower.
